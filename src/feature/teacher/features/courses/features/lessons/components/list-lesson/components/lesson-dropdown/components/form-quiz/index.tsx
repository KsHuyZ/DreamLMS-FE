...
import Answers from '@/feature/teacher/features/courses/features/lessons/components/list-lesson/components/lesson-dropdown/components/form-quiz/components/answers';
