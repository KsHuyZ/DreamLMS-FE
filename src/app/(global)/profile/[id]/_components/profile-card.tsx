      ...
      <CardContent className='p-0'>
        <div className='relative h-35 md:h-65'>
          ...
          <div className='absolute bottom-1 right-1 z-10 xsm:bottom-4 xsm:right-4'>
            <label
              htmlFor='cover'
              className='flex cursor-pointer items-center justify-center gap-2 text-black bg-primary py-1 px-2 text-sm font-medium hover:bg-opacity-90 xsm:px-4 bg-white p-2 rounded-md'
            >
          ...
          <div className='absolute bottom-1 left-5'>
            <div className='flex items-center space-x-4'>
              <div className='relative z-10 drop-shadow-2'>
                ...
                <label
                  htmlFor='profile'
                  className='absolute bottom-0 right-0 flex h-8.5 w-8.5 cursor-pointer items-center justify-center rounded-full bg-primary text-white hover:bg-opacity-90 sm:bottom-2 sm:right-2 bg-primary-600 p-2'
                >
                  <svg
                    className='fill-current'
                    width='14'
